...
contract ApiMonetization {
  ...
  function purchaseApiCalls(address signingKey, string numCalls, uint nonce, uint expiration, bytes32 payload, bytes32 hash, uint8 v, bytes32 r, bytes32 s) public payable {
